...
namespace AoC18
{
    public class StateDictionary
    {
        ...
        private struct Entry
        {
            ...
            public State key;     // Key of entry
            public int value;     // Value of entry
            public int next;
        }

        public StateDictionary(int capacity)
        {
        ...
        private void Add(State key, int value)
        {
        ...
        public bool ContainsKey(State key)
        {
            return FindEntry(key) >= 0;
        }

        private int FindEntry(State key)
        {
